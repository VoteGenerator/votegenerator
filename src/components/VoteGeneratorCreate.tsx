// ============================================================================
// VoteGeneratorCreate - FORM ONLY Component with Geo-Aware Paywall
// 
// NOTE: This renders ONLY the form content.
// Parent page (LandingPage) handles: PromoBanner, NavHeader, title, Footer
// ============================================================================
...
import { useGeoPricing, getCheckoutUrl } from '../geoPricing';
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full overflow-hidden">
                ...
                <div className="p-6">
                            ...
                            {loading ? (
                                ...
                                <>
                                    <span className="text-3xl font-bold text-slate-900">
                                        {prices.symbol}{prices.proEvent}
                                    </span>
                                    <span className="text-slate-500 ml-1">{currency}</span>
                                </>
                            )}
                        </div>
                        <span className="px-3 py-1 bg-emerald-100 text-emerald-700 text-sm font-bold rounded-full">One-time payment</span>
                    </div>
                    <div className="flex gap-3">
                        ...
                        <a href={getCheckoutUrl('pro_event', currency)} className="flex-1 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold rounded-xl hover:shadow-lg transition flex items-center justify-center gap-2">
...
// ============================================================================
// Main Form Component - NO headers, NO banners, NO footer
// ============================================================================
