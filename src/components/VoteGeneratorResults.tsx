    ...
    return (
        <div className="space-y-6 print:space-y-4">
            ...
            <div className="flex flex-wrap justify-end gap-2 print:hidden">
                <div className="bg-white border border-slate-200 rounded-lg p-1 flex gap-1 shadow-sm overflow-x-auto">
                    <button
            ...
            <AnimatePresence mode="wait">
                {/* --- WINNER CARD (Shown on Bar and Rounds views) --- */}
                {(viewMode === 'rounds' || viewMode === 'bar') && winnerId && isRanked && (
                     <motion.div 
                        key="winner"
                ...
                {viewMode === 'bar' && (
                    ...
                    >
                        <h3 className="text-xl font-bold text-slate-800 mb-6 flex items-center gap-2">
                            ...
                            {isRanked ? 'First Preference Votes' : 'Vote Breakdown'}
                        </h3>
