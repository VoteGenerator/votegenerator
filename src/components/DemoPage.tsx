...
const DemoPage: React.FC = () => {
    ...
    const [activeTab, setActiveTab] = useState<'overview' | 'types' | 'use-cases'>('overview');
                                    ...
                                    {pollTypes.map((poll) => (
                                        ...
                                        >
                                            <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                                                ...
                                                <poll.icon size={20} className={selectedPoll === poll.id ? 'text-white' : 'text-white'} />
                                            </div>
                                        ...
                                        >
                                            ...
                                            <div className="p-6 space-y-6">
                                                ...
                                                <div className="bg-slate-50 rounded-xl p-4">
                                                    <h3 className="font-bold text-slate-800 mb-3">Example</h3>
                                                    <p className="text-slate-700 font-medium mb-2">{selectedPollData.exampleQuestion}</p>
                                                    <div className="space-y-2">
                                                        {selectedPollData.exampleOptions.map((opt, i) => (
                                                    ...
                                                    <div>
                                                        ...
                                                        <ul className="space-y-1">
                                                            {selectedPollData.bestFor.map((item, i) => (
                                                                <li key={i} className="text-sm text-slate-600 pl-7">• {item}</li>
                                                            ))}
                                                        </ul>
                                                    </div>
                                                    <div>
