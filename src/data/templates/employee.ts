...
// ─────────────────────────────────────────────
// 2. candidate-experience-survey → employee.ts
// ─────────────────────────────────────────────
export const CANDIDATE_EXPERIENCE_TEMPLATE = {
  id: "candidate-experience-survey",
  slug: "candidate-experience-survey",
  title: "Candidate Experience Survey",
  description:
    "9 questions covering job description clarity, application ease, recruiter communication, interview quality, perceived fairness, decision speed, employer brand impression, NPS, and open feedback.",
  category: "employee",
  tags: [
    "candidate",
    "recruitment",
  ...
  questions: [
    {
      id: "ce-01",
      text: "How clear and accurate was the job description in setting expectations for the role?",
      type: "scale",
      scale: 5,
      min: "Very unclear",
      max: "Very clear",
    ...
    {
      id: "ce-02",
      text: "How easy and straightforward was the application process?",
      type: "scale",
      scale: 5,
      min: "Very difficult",
      max: "Very easy",
    ...
    {
      id: "ce-03",
      text: "How well did the recruiter or hiring team communicate with you throughout the process?",
      type: "scale",
      scale: 5,
      min: "Poor communication",
      max: "Excellent communication",
    },
    {
      id: "ce-04",
      text: "How well organised and professionally run were your interviews?",
      type: "scale",
      scale: 5,
      min: "Poorly organised",
      max: "Very professional",
    },
    {
      id: "ce-05",
      text: "How fair and objective did the assessment and interview process feel?",
      type: "scale",
      scale: 5,
      min: "Felt unfair",
      max: "Very fair",
    ...
    {
      id: "ce-06",
      text: "How satisfied were you with the speed of the hiring decision and communication of the outcome?",
      type: "scale",
      scale: 5,
      min: "Very slow",
      max: "Very timely",
    ...
    {
      id: "ce-07",
      text: "How positive an impression do you have of this organisation as a place to work, based on your experience?",
      type: "scale",
      scale: 5,
      min: "Very negative",
      max: "Very positive",
    ...
    {
      id: "ce-08",
      text: "How likely are you to recommend applying to this organisation to someone in your network? (0–10)",
      type: "nps",
      scale: 10,
    },
    {
      id: "ce-09",
      text: "What is the one thing we could change to make the hiring process better for future candidates?",
      type: "open",
    },
  ],
  meta: {
    sendTiming: "Within 48 hours of final hiring decision",
    sendTo: ["rejected", "offer accepted", "offer declined", "withdrew"],
    anonymous: true,
    audience: ["HR teams", "talent acquisition", "employer brand managers"],
    keyChurnSignal: "ce-05",
    keyReferralSignal: "ce-08",
    note: "Send to ALL candidates who completed at least one interview, including those who were rejected",
  },
  landingPage: "/templates/candidate-experience-survey",
  prefillUrl:
    "https://votegenerator.com/create?template=candidate-experience-survey",
};

// ─────────────────────────────────────────────
// 6. team-building-survey → employee.ts
// ─────────────────────────────────────────────
export const TEAM_BUILDING_TEMPLATE = {
  id: "team-building-survey",
  slug: "team-building-survey",
  title: "Team Building Event Survey",
  description:
    "9 anonymous questions for HR teams and people managers. Covers activity enjoyment, team connection built, inclusion, facilitation quality, logistics, budget value, interest in similar activities, NPS, and open feedback.",
  category: "employee",
  tags: [
    "team building",
    "team activity",
  ...
  questions: [
    {
      id: "tb-01",
      text: "Overall, how much did you enjoy today's team activity?",
      type: "scale",
      scale: 5,
      min: "Did not enjoy",
      max: "Loved it",
    ...
    {
      id: "tb-02",
      text: "How well did the activity help you connect with and get to know your colleagues better?",
      type: "scale",
      scale: 5,
      min: "Not at all",
      max: "Very well",
    ...
    {
      id: "tb-03",
      text: "How inclusive and accessible was the activity for all team members?",
      type: "scale",
      scale: 5,
      min: "Very exclusionary",
      max: "Fully inclusive",
    },
    {
      id: "tb-04",
      text: "How well was the activity facilitated and organised?",
      type: "scale",
      scale: 5,
      min: "Poorly",
      max: "Excellently",
    ...
    {
      id: "tb-05",
      text: "How smoothly did the logistics run — venue, timing, instructions, and communication?",
      type: "scale",
      scale: 5,
      min: "Lots of issues",
      max: "Ran perfectly",
    ...
    {
      id: "tb-06",
      text: "How well did this activity represent a good use of company time and budget?",
      type: "scale",
      scale: 5,
      min: "Poor use",
      max: "Excellent use",
    ...
    {
      id: "tb-07",
      text: "How interested would you be in doing a similar type of activity again?",
      type: "scale",
      scale: 5,
      min: "Not at all",
      max: "Definitely yes",
    ...
    {
      id: "tb-08",
      text: "How likely are you to recommend this type of activity to another team in the company? (0–10)",
      type: "nps",
      scale: 10,
    },
    {
      id: "tb-09",
      text: "What is one thing that would have made today's activity better or more enjoyable for you?",
      type: "open",
    },
  ],
  meta: {
    sendTiming: "Within 24 hours of the activity",
    anonymous: true,
    audience: ["HR teams", "people managers", "team leads"],
    keySignal: "tb-03",
    note: "Q3 (inclusion) is the most important check. Any activity scoring below 3 on inclusion should not be repeated regardless of overall enjoyment score.",
  },
  landingPage: "/templates/team-building-survey",
  prefillUrl: "https://votegenerator.com/create?template=team-building-survey",
};
